    ...
    <section id="dry-skin-page" class="remedies-page">
        <div class="container">
            ...
            <div class="problems-grid">
                ...
                <div class="problem-card" data-category="aceites">
                    <div class="problem-header dry-skin-header">
                ...
                <div class="problem-card" data-category="mascarillas">
                    <div class="problem-header dry-skin-header">
                        <h3>Mascarilla de Plátano</h3>
                    </div>
                    <div class="problem-content">
                        <h3>Mascarilla Nutritiva de Plátano</h3>
                        <ul>
                            <li>1 plátano maduro</li>
                            <li>1 cucharada de miel</li>
                            <li>1 cucharadita de aceite de almendras</li>
                        </ul>
                        <p>Machaca el plátano hasta hacer puré, añade miel y aceite. Aplica sobre el rostro durante 15-20 minutos. Enjuaga con agua tibia.</p>
        ...
        <div class="container">
            ...
            <div class="problems-grid">
                ...
                <div class="problem-card" data-category="tonicos">
                    ...
                    <div class="problem-content">
                        <h3>Tónico Refrescante de Aloe Vera</h3>
                        <ul>
                            <li>3 cucharadas de gel de aloe vera</li>
                            <li>2 cucharadas de agua de rosas</li>
                            <li>1 cucharadita de hamamelis</li>
                        </ul>
                        <p>Mezcla todos los ingredientes. Conserva en refrigeración. Aplica con un algodón por la mañana y noche después de limpiar.</p>
                ...
                <div class="problem-card" data-category="exfoliantes">
                    ...
                    <div class="problem-content">
                        <h3>Exfoliante Revitalizante de Café</h3>
                        <ul>
                            <li>2 cucharadas de café molido usado</li>
                            <li>1 cucharada de aceite de coco</li>
                            <li>1 cucharadita de azúcar moreno</li>
                        </ul>
                        <p>Mezcla todos los ingredientes. Aplica con masajes circulares suaves. Enjuaga con agua tibia. Usa 2 veces por semana.</p>
            ...
            <div class="problems-grid">
                ...
                <div class="problem-card" data-category="exfoliantes">
                    ...
                    <div class="problem-content">
                        ...
                        <p>Mezcla todos los ingredientes. Aplica suavemente sobre el rostro con movimientos circulares. Deja actuar 10 minutos y enjuaga.</p>
                        <span class="benefit-tag">Suavizante</span>
                    </div>
                </div>
            </div>
